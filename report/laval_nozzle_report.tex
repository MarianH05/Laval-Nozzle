...
The isentropic reference calculations use the local Mach number and ideal-gas air constants \(\gamma=1.4\) and \(R=\SI{287}{J.kg^{-1}.K^{-1}}\). If a saved \texttt{Ma} field is absent, Mach number is reconstructed as
\begin{equation}
M = \frac{|\mathbf{U}|}{\sqrt{\gamma R T}} .
\end{equation}
...
\frac{p}{p_0} &=
\left(\frac{T}{T_0}\right)^{\frac{\gamma}{\gamma-1}}, \\
\frac{\rho}{\rho_0} &=
